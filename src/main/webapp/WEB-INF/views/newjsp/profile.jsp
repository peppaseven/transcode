					...
					<ul class="nav navbar-nav navbar-right">
						...
						<c:if test="${!empty sessionScope.user}">
							<li class="dropdown">
         					...
         					<li>
	         					   <a href="index.html"><img class="userphoto" src="${ctx}/static/useravatar/${sessionScope.user.avatar}"></a>
         					</li>
						</c:if>
					</ul>
				</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-6 col-md-push-3">
					<a href="${ctx}/profile/edit" style="text-decoration: none; font-size:20px;">
					<span class="icon-sm icon-edit"></span>
					Edit profile
					</a>
					<div class="row">
						<div class="col-md-3">
							<p><img src="${ctx}/static/useravatar/${sessionScope.user.avatar}" class="img-responsive img-rounded"></p>
						
						</div>
						<div class="col-md-9">
							<ul class="fh5co-list-check" style="font-size:22px;">
								<li>Name : ${sessionScope.user.username }</li>
								<li>Public email : ${sessionScope.user.email }</li>
								<li>User Type : 
								<c:if test="${sessionScope.user.accountType ==1 }">Normal</c:if>
								<c:if test="${sessionScope.user.accountType ==2 }">Facebook</c:if>
								<c:if test="${sessionScope.user.accountType ==3 }">Google</c:if></li>
							</ul>
						</div>
					</div>		
				</div>	
